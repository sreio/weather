...
```sh
$ composer require xw/weather
$ php artisan vendor:publish --provider="Xw\Weather\ServiceProvider" #发布配置
```
...
- [高德天气查询接口文档](https://lbs.amap.com/api/webservice/guide/api/weatherinfo/#weatherinfo)
